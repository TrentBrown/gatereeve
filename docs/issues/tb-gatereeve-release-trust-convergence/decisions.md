# Decisions - tb-gatereeve-release-trust-convergence
...
## Model schema v2 as append-only ordered stage history
...
**Promoted:** 2026-08-30. PR: #32.

---

## Keep notarization attempts separate from successful release stages
...
## Distinguish submitted and final stapled DMG identities
...
**Promoted:** 2026-08-30. PR: #33.

---

## Revalidate Plugin identity at every cross-run recovery boundary
...
## Fail closed when native Intel authority cannot be established
...
**Refined:** 2026-08-30 in PR #33 after hosted Intel runner evidence confirmed
the primary API's documented missing-key behavior.

**Promoted:** 2026-08-30. PR: #33.

---

## Retain repository-local publishers behind a schema-v2 hosted authority
...
**Promoted:** 2026-08-30. PR: #34.

---

## Advance the immutable public-Cask smoke fixture with public history
...
## Cut over Apple custody through validated overlap
...
**Promoted:** 2026-08-30. PR: https://github.com/TrentBrown/gatereeve/pull/37.

---

## Require real GitHub environment deployments for protected authority
