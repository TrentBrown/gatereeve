...
| Unit/integration | `cd apps/desktop && npm test` | PASS | Final rebased run: 137 tests passed. Coverage includes CommonMark/GFM DOM, hostile input, links, anchors, both surfaces, accessibility, staging, existing Desktop behavior, file actions, and phase-context work already on `main`. |
