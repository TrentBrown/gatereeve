...
**Focused slice:** `1d10d6da7b4acac054c31e65993a2f03bcbf0ee3..a981e3ed42a42cd2e2c173f041a732214b5151e4`
**Result:** PASS
...
| Unit and integration | `cd apps/desktop && npm test` | PASS | 137 tests passed after rebasing onto current `main`; zero failures or skips. |
...
of the 137-test passing run, so the combined renderer behavior is covered.
