# Decision Scratchpad - tb-desktop-markdown-rendering
...
## [1] Bundle a Unified syntax-tree pipeline
...
## [2] Preserve source before sanitizing semantic DOM
...
## [3] Defer Mermaid to an isolated follow-up
