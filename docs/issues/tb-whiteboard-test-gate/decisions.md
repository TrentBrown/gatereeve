...
## Separate ordering edges from evidence flow and constrain Whiteboard waivers
...
## Deduplicate identical feature and final-slice patches within provider budget
