...
## Publish approved records through the maintainer GitHub identity
...
**Promoted:** 2026-08-28. PR: https://github.com/TrentBrown/gatereeve/pull/16.

---

## Reserve the manifest publication timestamp during preparation
...
## Publish the Cask from a dedicated GateReeve tap
...
## Keep trusted Python execution from mutating packaged sources
...
## Verify public Cask bytes before installation
