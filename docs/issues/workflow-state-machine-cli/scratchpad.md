# Decision Scratchpad - workflow-state-machine-cli

**Feature start:** 2026-08-25

Working record of decisions made during this feature's implementation. Append
entries across delivery slices and sessions. Triage at each PR boundary;
promoted entries are appended to `decisions.md`.

## [1] Keep the protocol core canonical in plugin shared resources
...
## [2] Fail closed and roll forward interrupted model migrations
...
## [3] Verify merged content without requiring reviewed SHA ancestry
...
## [4] Stage complete canonical resources into the optional CLI package
