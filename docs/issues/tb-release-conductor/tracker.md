...
| R5 | Recovery semantics | PASS | [#52](https://github.com/TrentBrown/gatereeve/pull/52), [#57](https://github.com/TrentBrown/gatereeve/pull/57) | Failure records, tag-only routing, retained Apple recovery, and receipt idempotence pass local suites; PR #57 repairs the post-publication checkpoint needed to resume RC.11. |
