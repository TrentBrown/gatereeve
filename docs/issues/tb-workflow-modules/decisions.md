...
## Separate persistent shells from explicitly authorized module tasks
...
**Promoted:** 2026-09-03. PR: #63.

---

## Treat installed providers as one-shot fail-closed observation peers
...
## Bind finalization passage to a historical model and exact merge
...
**Promoted:** 2026-09-03. PR: #64.

---

## Package the GateReeve release observer as a self-contained exact peer
...
## Validate candidate journals before atomic append
...
## Normalize historical final merges and replace stale attempts safely
