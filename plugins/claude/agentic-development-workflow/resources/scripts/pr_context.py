...
def main() -> int:
    ...
    resolve_parser.add_argument("--gh-executable", default="gh")
    ...
    current_parser.add_argument("--git-executable", default="git")
    ...
    finalize_parser.add_argument("--git-executable", default="git")
    finalize_parser.add_argument("--gh-executable", default="gh")
