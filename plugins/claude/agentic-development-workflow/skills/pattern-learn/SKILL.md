...
Deferred from pattern-review v1. Use this only when the user explicitly asks to
process normalized learning events or continue the later learning-loop work.
