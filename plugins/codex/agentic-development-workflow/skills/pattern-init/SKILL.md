---
name: pattern-init
description: "Initialize a pattern-review rule scope. Use before pattern-extract, pattern-promote, or pattern-review when a repo, client directory, worktree, or parent scope does not yet have a .pattern-review directory and empty lifecycle YAML files."
---
